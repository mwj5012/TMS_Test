...
<body>
	...
	<form action="joinProc.jsp">
		...
		if(request.getAttribute("errors") != null){
			List<String> errors = (List)request.getAttribute("errors"); //가져올 때는 getAttribute() 
		...
		<input type="tel" name="cphone" /> 예)010-1111-5555, 정규식으로 처리 <br />
		<label for="">이메일</label>
		<input type="email" name="email" /> <br />
		<label for="">취미</label>
		<input type="checkbox" name="habit" value="music" /> 음악 <!-- 체크박스는 배열로 처리 -->
